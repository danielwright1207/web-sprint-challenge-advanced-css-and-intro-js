...
accessiblility is making sure web pages on the internet are accessable to all people even with they have auditory, visual, or physical disabilities.

2. Talk about 3 different things you can do to ensure your website is accessible.

have a screen reader, using responsive units so that your page can scale regardless of screen size or what platform it may be on (phone, tablet, desktop), making sure if you have a colorful webpage you apple visual counterparts to ensure people who are colorblind can access your page properly

3. How would you explain the concept of a variable to someone new to programming?

variables are a way of storing information or data such as a name, a number, a value and be able to call upon it later.

4. What is the purpose of using functions in code?

functions allow you to store sections of code that do a task or "function" then call that function later to perform that take without having to write out the same code multiple times.
