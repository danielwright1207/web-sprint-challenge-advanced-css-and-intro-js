...
function getArtistByIndex(array, index /*Your Code Here*/) {
  return `the artist at index ${array[index].id} is ${array[index].name}`; /*Your Code Here*/
}
...
function get20s(artists /*Your Code Here*/) {
  let in20s = [];
  for (let i = 0; i < artists.length; i++) {
    if (artists[i].years.includes("19 - 2")) {
      in20s.push(artists[i].years);
    }
    return in20s;
    console.log(in20s);
  } /*Your Code Here*/
...
function lotsOfArt(artists /*Your Code Here*/) {
  let paintAll = [];
  for (let i = 0; i < artists.length; i++) {
